...
bool QNode::init() {
    ...
    set_mode_msg_pub = n.advertise<std_msgs::String>("/robotis/demo/set_mode_msg", 0);
...
void QNode::AR1PoseCallback( geometry_msgs::Pose ar_pose_msg )
{
    if ( get_ar_pose == true && cnt > tol_cnt )
    {
        ...
        ar_1_pose_msg.position.x -= 0.025;
        ar_1_pose_msg.position.y -= 0.005;
...
void QNode::AR2PoseCallback( geometry_msgs::Pose ar_pose_msg )
{
    if ( get_ar_pose == true && cnt > tol_cnt )
    {
        ...
        ar_2_pose_msg.position.x -= 0.025;
        ar_2_pose_msg.position.y -= 0.005;
